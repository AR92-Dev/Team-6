...
Open index.html using a simple local server (Highly recommended: Live Server extension in VS Code).
Register a new account, log in, browse live prices, toggle currencies (USD ⇄ JOD), and manage your dynamic gold assets vault!
